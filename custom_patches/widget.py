...
class ChartWizardWidget(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        ...
        self.interval_combo.addItems(["日线 (Daily)", "分钟 (Minute)"])
        ...
        hbox.addWidget(QtWidgets.QLabel("周期"))
    ...
    def close_tab(self, index: int) -> None:
        ...
        self.intervals.pop(vt_symbol, None)
    ...
    def new_chart(self) -> None:
        ...
        if "日线" in combo_text:
            ...
            days = 3650  # 10 years of history
        else:
            interval = Interval.MINUTE
            days = 15    # 15 days of history

        self.intervals[vt_symbol] = interval
    ...
    def process_tick_event(self, event: Event) -> None:
        ...
        if bg:
            interval = self.intervals.get(tick.vt_symbol, Interval.MINUTE)
            ...
            if interval == Interval.MINUTE:
                ...
                dt = tick.datetime.replace(hour=0, minute=0, second=0, microsecond=0)
                bar = BarData(
                    symbol=tick.symbol,
